...
4. Ziel Menü
5. Spiel
   a) underwaterview rechts
   b) submarineview links
...
##### underwater view
1. Spielerfigur: U-Boot
2. Hintergrund (Wasser)
3. optional: (evtl primary/secondary fire -> erstmal nur Torpedos, schauen wir später, ob wir das noch einbauen)
4. Waffen:
   a) Torpedos
   b) Laserstrahl
6. Gegner U-Boote
   a) normale Gegner
   b) mini boss
   c) Kraken (geht schräge über map)
8. Animation:
   a) Gegner getötet
   b) Spieler stirbt
9. optional: NPCs??
...
##### UI
1. Health anzeige: Herzen
2. Anzeigen für underwaterview etc

#### Audio
1. Wenn man einen Torpedo abschießt
2. wenn man getroffen wird, warn sound
3. wenn man stirbt
4. Bosskampf Musik
